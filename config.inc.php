...
$settings['theme'] = 'stb'; // Theme file (layout/theme_$n.css). Look at the contents of the layout/ folder for other themes.
...
$settings['services']['pidFiles'] = array(
	 ...
	 //'Minecraft server' => '/var/run/screen/S-pozzard/83305.pts-1.bonzzard'
	 //'Minecraft server' => 'java -jar -Xmx2G craftbkukkit-1.18.jar'
);
